  ...
  head: function Head({title, meta}) {
    const ogImage =
      ...
      urlcat("https://ogmeta.vercel.app/", {
        ...
        subtitle:
          "Substore - TThe data platform built from the ground up" ?? undefined,
        dark: "true",
      });
    ...
    return (
      <>
        ...
        <meta
          ...
          content={
            meta.description ||
            "Substore = The data store platform built from the ground up"
          }
        />
        <meta
          name="og:description"
        ...
        <meta
          name="twitter:image"
          content={
            "https://user-images.githubusercontent.com/59238070/194098589-eb4c526f-f52a-4dd4-acf4-9fa23058e2fb.png"
          }
        />
        <meta
          name="og:title"
        ...
        <meta
          name="description"
          content="Substore - The data store platform built from the ground up"
        />
        <meta
          name="og:title"
          content="Datalink - The analytics platform for the future"
        />{" "}
        <meta
          name="og:image"
          content={
            "https://media.discordapp.net/attachments/1011641273393885239/1016003920155398226/Bannerwide-2.png?width=1440&height=480"
          }
        />
        <style>
          {`img[decoding] {
